...
public class LinkedHashMap_Demo {
    ...
    public void map_Collection_demo(){
        ...
        LinkedHashMap<String, String> hm3 = new LinkedHashMap<String, String>(5);
        LinkedHashMap<String, Integer> hm4 = new LinkedHashMap<String, Integer>(5,0.75f);

        //Creating a Map from another Map
        Map<String, Integer> hmm = new LinkedHashMap<String, Integer>();
        ...
        LinkedHashMap<String, Integer> hmm1 = new LinkedHashMap<String, Integer>(hmm);
