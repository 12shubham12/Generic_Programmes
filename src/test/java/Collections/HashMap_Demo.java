/*
1. Representation of group of Objects as Key-Value pair
...
5. underlying datastrurcture is HashTable
6. Insertion order is not preserved but objects are stored based on hashcode of keys and not values
7. null value is not allowed for key and values
8. Best if operation is search operation
 */
...
public class HashMap_Demo {
    ...
    public void map_Collection_demo(){
        ...
        //Constructors
        //creates empty Hashtable with default initial capacity=16 and Fill Ratio=0.75
        HashMap hm1 = new HashMap();
        HashMap<String, String> hm2 = new HashMap<String, String>();

        HashMap<String, String> hm3 = new HashMap<String, String>(5);
        HashMap<String, Integer> hm4 = new HashMap<String, Integer>(5,0.75f);
        ...
        HashMap<String, Integer> hmm1 = new HashMap<String, Integer>(hmm);
